...
@supports (background-clip: text) {
  .text-color-main {
    ...
    color: #0000;
    background-image: linear-gradient(135deg, #16bffd 0%, #cb3066 100%);
...
.cta-btn--hero {
  ...
  border-style: solid;
  border-width: 2px;
  border-image: linear-gradient(135deg, #16bffd 0%, #cb3066 100%) 1;
}
...
#projects .project-wrapper__image .thumbnail {
  ...
  box-shadow: 0 6px 10px #00000014, 0 0 6px #0000000d;
}
